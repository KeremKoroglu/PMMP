...
namespace PersonalMoneyManagementAndPlanning.Classes
{
    public static class Database
    {
        ...
        private static readonly string tbUsers = "Users", tbIncomes = "Incomes", tbExpenses = "Expenses", tbAccounts = "Accounts", tbIEC = "IncomeAndExpenseCategories", tbAC = "AccountCategories";
